...
function changeLanguage(language) {
  ...
  loadLanguageFile(language)
    .then(data => {
      ...
      document.getElementById('serv_title_data_descText').innerText = data.serv_title_data_desc;
      document.getElementById('serv_title_webText').innerText = data.serv_title_web;
      document.getElementById('serv_title_web_descText').innerText = data.serv_title_web_desc;
      document.getElementById('serv_title_mobileText').innerText = data.serv_title_mobile;
      document.getElementById('serv_title_mobile_descText').innerText = data.serv_title_mobile_desc;
      document.getElementById('serv_title_apiText').innerText = data.serv_title_api;
      document.getElementById('serv_title_api_descText').innerText = data.serv_title_api_desc;
      document.getElementById('serv_title_erpText').innerText = data.serv_title_erp;
      document.getElementById('serv_title_erp_descText').innerText = data.serv_title_erp_desc;
      document.getElementById('serv_title_crmText').innerText = data.serv_title_crm;
      document.getElementById('serv_title_crm_descText').innerText = data.serv_title_crm_desc;
      document.getElementById('serv_title_acaText').innerText = data.serv_title_aca;
      document.getElementById('serv_title_aca_descText').innerText = data.serv_title_aca_desc;
